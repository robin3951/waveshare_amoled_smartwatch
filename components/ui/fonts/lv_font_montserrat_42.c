 ...
 * Size: 42 px
 * Bpp: 4
 * Opts: --bpp 4 --size 42 --no-compress --stride 1 --align 1 --font Montserrat-Medium.ttf --symbols 0123456789 --format lvgl -o lv_font_montserrat_42.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 448, .box_w = 24, .box_h = 30, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 360, .adv_w = 249, .box_w = 12, .box_h = 30, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 540, .adv_w = 386, .box_w = 23, .box_h = 30, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 885, .adv_w = 384, .box_w = 23, .box_h = 30, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1230, .adv_w = 450, .box_w = 27, .box_h = 30, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1635, .adv_w = 386, .box_w = 23, .box_h = 30, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1980, .adv_w = 415, .box_w = 23, .box_h = 30, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2325, .adv_w = 402, .box_w = 23, .box_h = 30, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2670, .adv_w = 433, .box_w = 25, .box_h = 30, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3045, .adv_w = 415, .box_w = 23, .box_h = 30, .ofs_x = 1, .ofs_y = 0}
};
