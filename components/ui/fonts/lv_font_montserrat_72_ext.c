 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --font managed_components/lvgl__lvgl/scripts/built_in_font/Montserrat-Medium.ttf -r 0x2D -r 0x3A -r 0x30-0x39 --size 72 --format lvgl --bpp 4 --no-compress -o components/ui/fonts/lv_font_montserrat_72_ext.c
 ******************************************************************************/
...
#ifndef LV_FONT_MONTSERRAT_72_EXT
#define LV_FONT_MONTSERRAT_72_EXT 1
#endif

#if LV_FONT_MONTSERRAT_72_EXT
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t lv_font_montserrat_72_ext = {
#else
lv_font_t lv_font_montserrat_72_ext = {
#endif
...
#endif /*#if LV_FONT_MONTSERRAT_72_EXT*/
